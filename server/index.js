...
const deleteUserProfileController = require("./controllers/deleteUserProfileController");
const app = express();
...
app.delete("/api/delete_user/:user_id", deleteUserProfileController.deleteUser);
///////////////////////////////
// Fallback Route
///////////////////////////////
